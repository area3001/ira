...
import (
	"fmt"
	"github.com/area3001/ira/comm"
	"github.com/area3001/ira/sdk"
...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&server, "server", "s", "nats://51.15.125.58:4222", "The server to connect to")
